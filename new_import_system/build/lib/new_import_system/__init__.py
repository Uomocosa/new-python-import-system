...
def install():
    ...
    top_package = importers[1]
    assert top_package.name == "__init__.py", "Install new_importer_system inside the '__init__.py' of your top level package of your project"
    if DEBUG: print(f"top_package: {top_package}")
    sys_key = top_package.parent.name
