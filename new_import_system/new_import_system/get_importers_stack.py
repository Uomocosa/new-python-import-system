...
def get_importers_stack(DEBUG=False, VERBOSE=False) -> Path:
    """
    Returns the import stack, excluded the importlib machinery.
    Works fine but is a little hacky, did not find a better solution
    """
    ...
    return [P(frame.filename) for frame in import_frames]